...
CATALOG: list[dict] = [
    # ---------------- świat, szeroki rynek
    {"sym": "VWCE.DE", "isin": "IE00BK5BQT80", "name": "Vanguard FTSE All-World", "region": "world", "sector": "broad",
    ...
    {"sym": "IWDA.AS", "isin": "IE00B4L5Y983", "name": "iShares Core MSCI World", "region": "world", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Rynki rozwinięte, bez rynków wschodzących. Klasyk portfeli pasywnych."},
    {"sym": "SWRD.L", "isin": "IE00BFY0GT14", "name": "SPDR MSCI World", "region": "world", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "To samo co MSCI World, ale z niższą opłatą roczną."},
    {"sym": "EUNL.DE", "isin": "IE00B4L5Y983", "name": "iShares Core MSCI World (Xetra)", "region": "world", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Ten sam fundusz co IWDA, notowany we Frankfurcie — wygodniejszy przy rachunku w euro."},
    {"sym": "ISAC.L", "isin": "IE00B6R52259", "name": "iShares MSCI ACWI", "region": "world", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Rynki rozwinięte i wschodzące razem, w jednym koszyku."},
    {"sym": "IWMO.L", "isin": "IE00BP3QZ825", "name": "iShares Edge MSCI World Momentum", "region": "world", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Kupuje to, co ostatnio rosło najmocniej. Działa świetnie w trendzie, boleśnie przy zwrocie."},
    {"sym": "IWQU.L", "isin": "IE00BP3QZ601", "name": "iShares Edge MSCI World Quality", "region": "world", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Filtr jakości: stabilne zyski, niskie zadłużenie. Spokojniejszy przebieg niż szeroki rynek."},
    {"sym": "IUSN.DE", "isin": "IE00BF4RFH31", "name": "iShares MSCI World Small Cap", "region": "world", "sector": "small",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Małe spółki z całego świata — historycznie wyższy zwrot kosztem większych wahań."},

    # ---------------- USA
    {"sym": "CSPX.L", "isin": "IE00B5BMR087", "name": "iShares Core S&P 500", "region": "usa", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "500 największych spółek amerykańskich. Punkt odniesienia dla całego rynku."},
    {"sym": "SXR8.DE", "isin": "IE00B5BMR087", "name": "iShares Core S&P 500 (Xetra)", "region": "usa", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "S&P 500 kupowany za euro — waluta rozliczenia inna, ryzyko dolara to samo."},
    {"sym": "VUAA.L", "isin": "IE00BFMXXD54", "name": "Vanguard S&P 500", "region": "usa", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "S&P 500 od Vanguarda, akumulujący. Jedna z najniższych opłat na rynku."},
    {"sym": "CNDX.L", "isin": "IE00B53SZB19", "name": "iShares Nasdaq 100", "region": "usa", "sector": "tech",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Sto największych spółek technologicznych z Nasdaq. Mocno skoncentrowany na kilku gigantach."},
    {"sym": "SXRV.DE", "isin": "IE00B53SZB19", "name": "iShares Nasdaq 100 (Xetra)", "region": "usa", "sector": "tech",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Nasdaq 100 rozliczany w euro."},
    {"sym": "IUIT.L", "isin": "IE00B3WJKG14", "name": "iShares S&P 500 Technology", "region": "usa", "sector": "tech",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Wyłącznie sektor technologiczny z indeksu S&P 500."},
    {"sym": "IUHC.L", "isin": "IE00B43HR379", "name": "iShares S&P 500 Health Care", "region": "usa", "sector": "health",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Ochrona zdrowia z S&P 500 — branża, która najmniej reaguje na spowolnienie."},
    {"sym": "IUFS.L", "isin": "IE00B4JNQZ49", "name": "iShares S&P 500 Financials", "region": "usa", "sector": "finance",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Amerykańskie banki i ubezpieczyciele."},
    {"sym": "IESU.L", "isin": "IE00B42NKQ00", "name": "iShares S&P 500 Energy", "region": "usa", "sector": "energy",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Sektor naftowo-gazowy z S&P 500."},
    {"sym": "IUVL.L", "isin": "IE00BD1F4M44", "name": "iShares MSCI USA Value Factor", "region": "usa", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Tańsza wycenowo część rynku USA — mniej technologii, więcej przemysłu i finansów."},
    {"sym": "R2US.L", "isin": "IE00BJ38QD84", "name": "SPDR Russell 2000 US Small Cap", "region": "usa", "sector": "small",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Dwa tysiące małych spółek amerykańskich."},
    {"sym": "IDVY.L", "isin": "IE00B0M62S72", "name": "iShares Euro Dividend", "region": "europe", "sector": "dividend",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "Trzydzieści europejskich spółek o najwyższej stopie dywidendy."},
    {"sym": "VHYL.L", "isin": "IE00B8GKDB10", "name": "Vanguard FTSE All-World High Dividend", "region": "world", "sector": "dividend",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "Spółki dywidendowe z całego świata — regularna wypłata zamiast reinwestycji."},
    {"sym": "ISPA.DE", "isin": "DE000A0F5UH1", "name": "iShares STOXX Global Select Dividend 100", "region": "world", "sector": "dividend",
     "asset": E, "cur": "EUR", "acc": False,
     "note": "Setka najhojniej dzielących się zyskiem spółek świata."},
    {"sym": "XDWD.DE", "isin": "IE00BJ0KDQ92", "name": "Xtrackers MSCI World", "region": "world", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Alternatywa dla iShares Core MSCI World, ta sama ekspozycja u innego dostawcy."},
    {"sym": "DBXJ.DE", "isin": "LU0274209740", "name": "Xtrackers MSCI Japan", "region": "asia", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Japonia rozliczana w euro."},

    # ---------------- Europa
    {"sym": "MEUD.PA", "isin": "LU0908500753", "name": "Lyxor Core STOXX Europe 600", "region": "europe", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Sześćset największych spółek europejskich — odpowiednik S&P 500 dla Europy."},
    {"sym": "EXSA.DE", "isin": "IE0004YCLDW1", "name": "iShares STOXX Europe 600", "region": "europe", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": False,
     "note": "Szeroki rynek europejski z wypłatą dywidendy."},
    {"sym": "EXV1.DE", "isin": "DE000A0F5UJ7", "name": "iShares STOXX Europe 600 Banks", "region": "europe", "sector": "finance",
     "asset": E, "cur": "EUR", "acc": False,
     "note": "Wyłącznie europejskie banki — bardzo cykliczne, mocno reagują na stopy."},
    {"sym": "ESIT.L", "isin": "IE00BMW42413", "name": "iShares MSCI Europe Information Technology", "region": "europe", "sector": "tech",
    ...
    {"sym": "EIMI.L", "isin": "IE00BKM4GZ66", "name": "iShares Core MSCI EM IMI", "region": "em", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Ponad trzy tysiące spółek z rynków wschodzących, łącznie z małymi."},
    {"sym": "IS3N.DE", "isin": "IE00BKM4GZ66", "name": "iShares Core MSCI EM IMI (Xetra)", "region": "em", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Ten sam fundusz co EIMI, notowany we Frankfurcie."},
    {"sym": "FLXI.DE", "isin": "IE00BHZRQZ17", "name": "Franklin FTSE India", "region": "em", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Wyłącznie Indie — najszybciej rosnąca duża gospodarka świata."},
    {"sym": "CNYA.L", "isin": "IE00BJ5JPG56", "name": "iShares MSCI China A", "region": "em", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Chińskie spółki notowane na giełdach kontynentalnych."},
    {"sym": "IJPA.L", "isin": "IE00B4L5YX21", "name": "iShares Core MSCI Japan IMI", "region": "asia", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Szeroki rynek japoński."},
    {"sym": "IPRP.L", "isin": "IE00B0M63284", "name": "iShares European Property Yield", "region": "europe", "sector": "realestate",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "Europejskie spółki nieruchomościowe wypłacające czynsze w formie dywidendy."},

    # ---------------- świat bez USA
    {"sym": "EXUS.L", "isin": "IE0006WW1TQ4", "name": "Xtrackers MSCI World ex USA", "region": "exus", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Cały świat z pominięciem Ameryki — dla kogoś, kto ma już dużo USA."},
    {"sym": "IEUX.L", "isin": "IE00B14X4N27", "name": "iShares MSCI Europe ex-UK", "region": "europe", "sector": "broad",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "Europa kontynentalna bez Wielkiej Brytanii."},

    # ---------------- branże wąskie
    {"sym": "XAIX.DE", "isin": "IE00BGV5VN51", "name": "Xtrackers AI & Big Data", "region": "world", "sector": "ai",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Spółki zarabiające na sztucznej inteligencji i przetwarzaniu danych."},
    {"sym": "WTAI.L", "isin": "IE00BDVPNG13", "name": "WisdomTree Artificial Intelligence", "region": "world", "sector": "ai",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Wąski koszyk firm budujących modele i infrastrukturę AI."},
    {"sym": "SMH.L", "isin": "IE00BMC38736", "name": "VanEck Semiconductor", "region": "world", "sector": "semis",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Największe firmy półprzewodnikowe świata — sedno boomu na AI i najbardziej cykliczna branża technologii."},
    {"sym": "CHIP.L", "isin": "IE0001QF56M0", "name": "KraneShares S&P China 500", "region": "em", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Pięćset największych chińskich spółek — także tych notowanych w Szanghaju, "
             "do których zwykłe fundusze na Chiny nie sięgają."},
    {"sym": "BTEC.L", "isin": "IE00BYXG2H39", "name": "iShares Nasdaq US Biotechnology", "region": "usa", "sector": "biotech",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Amerykańska biotechnologia — kursy chodzą za wynikami badań, nie za gospodarką."},
    {"sym": "WCBR.L", "isin": "IE00BLPK3577", "name": "WisdomTree Cybersecurity", "region": "world", "sector": "tech",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Spółki od cyberbezpieczeństwa — wydatki na ochronę rosną niezależnie od koniunktury."},
    {"sym": "HEAL.L", "isin": "IE00BYZK4776", "name": "iShares Healthcare Innovation", "region": "world", "sector": "health",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Firmy zmieniające sposób leczenia: genetyka, robotyka chirurgiczna, cyfrowa medycyna."},
    {"sym": "ASWC.DE", "isin": "IE000OJ5TQP4", "name": "HANetf Future of Defence", "region": "world", "sector": "defence",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Przemysł zbrojeniowy NATO — rośnie z budżetami obronnymi państw."},
    {"sym": "INRG.L", "isin": "IE000U58J0M1", "name": "iShares Global Clean Energy", "region": "world", "sector": "clean",
     "asset": E, "cur": "GBP", "acc": True,
     "note": "Energia odnawialna. Bardzo wrażliwa na stopy procentowe i decyzje polityczne."},
    {"sym": "DH2O.L", "isin": "IE00B1TXK627", "name": "iShares Global Water (USD)", "region": "world", "sector": "clean",
     "asset": E, "cur": "USD", "acc": False,
     "note": "Infrastruktura wodna — nudna, powtarzalna, słabo skorelowana z technologią."},
    {"sym": "LOCK.L", "isin": "IE00BG0J4C88", "name": "iShares Digital Security", "region": "world", "sector": "tech",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Cyberbezpieczeństwo i ochrona tożsamości cyfrowej."},
    {"sym": "IWDP.L", "isin": "IE00B1FZS350", "name": "iShares Developed Markets Property", "region": "world", "sector": "realestate",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "Nieruchomości komercyjne z rynków rozwiniętych, w formie REIT-ów."},

    # ---------------- surowce i złoto
    {"sym": "SGLN.L", "isin": "IE00B4ND3602", "name": "iShares Physical Gold", "region": "world", "sector": "gold",
     "asset": C, "cur": "GBP", "acc": True,
     "note": "Fizyczne złoto w sztabach w skarbcu. Klasyczne zabezpieczenie portfela."},
    {"sym": "4GLD.DE", "isin": "DE000A0S9GB0", "name": "Xetra-Gold", "region": "europe", "sector": "gold",
    ...
    {"sym": "CMOD.L", "isin": "IE00BF4J0300", "name": "Invesco Bloomberg Commodity", "region": "world", "sector": "commodity",
     "asset": C, "cur": "USD", "acc": True,
     "note": "Koszyk surowców: energia, metale, rolnictwo. Osłona przed inflacją."},

    # ---------------- obligacje
    {"sym": "IBTA.L", "isin": "IE00B14X4S71", "name": "iShares $ Treasury Bond 1-3yr", "region": "usa", "sector": "bond",
     "asset": B, "cur": "USD", "acc": False,
     "note": "Krótkie obligacje skarbu USA — najbliższa gotówce forma inwestycji w dolarze."},
    {"sym": "IBTM.L", "isin": "IE00B1FZS798", "name": "iShares $ Treasury Bond 7-10yr", "region": "usa", "sector": "bond",
     "asset": B, "cur": "GBP", "acc": False,
     "note": "Średnioterminowy dług USA. Rośnie, gdy rynek boi się recesji."},
    {"sym": "IEAC.L", "isin": "IE00B3F81R35", "name": "iShares Core € Corp Bond", "region": "europe", "sector": "bond",
     "asset": B, "cur": "EUR", "acc": False,
     "note": "Obligacje dużych firm europejskich o wysokim ratingu."},
    {"sym": "AGGH.AS", "isin": "IE00BDBRDM35", "name": "iShares Global Aggregate Bond", "region": "world", "sector": "bond",
     "asset": B, "cur": "EUR", "acc": True,
     "note": "Cały światowy rynek długu w jednym funduszu, z zabezpieczeniem walutowym."},

    # ---------------- krypto
    {"sym": "BTCE.DE", "isin": "DE000A27Z304", "name": "Bitwise Physical Bitcoin", "region": "world", "sector": "crypto",
     "asset": K, "cur": "EUR", "acc": True,
     "note": "Bitcoin kupowany przez zwykły rachunek maklerski. Zmienność wielokrotnie wyższa niż akcji."},
    {"sym": "ZETH.DE", "isin": "DE000A3GMKD7", "name": "Bitwise Physical Ethereum", "region": "world", "sector": "crypto",
     "asset": K, "cur": "EUR", "acc": True,
...
CATALOG += [
    # ---------------- świat, szeroki rynek
    {"sym": "SPYY.DE", "isin": "IE00B44Z5B48", "name": "SPDR MSCI All Country World", "region": "world", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Rynki rozwinięte i wschodzące w jednym funduszu, taniej niż u konkurencji."},
    {"sym": "VWRL.L", "isin": "IE00B3RBWM25", "name": "Vanguard FTSE All-World (wypłacający)", "region": "world", "sector": "broad",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "To samo co VWCE, ale dywidendy wypłaca na rachunek zamiast reinwestować."},
    {"sym": "VEVE.L", "isin": "IE00BKX55T58", "name": "Vanguard FTSE Developed World", "region": "world", "sector": "broad",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "Rynki rozwinięte od Vanguarda, z wypłatą dywidendy."},
    {"sym": "WSML.L", "isin": "IE00BF4RFH31", "name": "iShares MSCI World Small Cap", "region": "world", "sector": "small",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Małe spółki z rynków rozwiniętych — inne ryzyko i inny cykl niż wielkie koncerny."},
    {"sym": "XDEM.DE", "isin": "IE00BL25JP72", "name": "Xtrackers MSCI World Momentum", "region": "world", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Stawia na spółki, które ostatnio rosły najszybciej. Świetne w trendzie, bolesne przy zwrocie."},
    {"sym": "XDEQ.DE", "isin": "IE00BL25JL35", "name": "Xtrackers MSCI World Quality", "region": "world", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Filtr jakości: wysoka rentowność, niskie zadłużenie, stabilne zyski."},
    {"sym": "XDEV.DE", "isin": "IE00BL25JM42", "name": "Xtrackers MSCI World Value", "region": "world", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Tania wycenowo połowa świata — mniej technologii, więcej przemysłu i banków."},
    {"sym": "JPGL.L", "isin": "IE00BJRCLL96", "name": "JPM Global Equity Multi-Factor", "region": "world", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Łączy kilka strategii naraz: wartość, jakość i momentum."},
    {"sym": "IWVL.L", "isin": "IE00BP3QZB59", "name": "iShares MSCI World Value Factor", "region": "world", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Spółki notowane poniżej wartości księgowej i z niskimi wskaźnikami wyceny."},

    # ---------------- USA
    {"sym": "VUSA.L", "isin": "IE00B3XXRP09", "name": "Vanguard S&P 500 (wypłacający)", "region": "usa", "sector": "broad",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "S&P 500 z kwartalną wypłatą dywidendy."},
    {"sym": "SPY5.L", "isin": "IE00B6YX5C33", "name": "SPDR S&P 500", "region": "usa", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "S&P 500 od State Street, jeden z najtańszych na rynku."},
    {"sym": "IUSA.L", "isin": "IE0031442068", "name": "iShares Core S&P 500 (wypłacający)", "region": "usa", "sector": "broad",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "Wersja S&P 500 wypłacająca dywidendę na rachunek."},
    {"sym": "EQQQ.L", "isin": "IE0032077012", "name": "Invesco EQQQ Nasdaq-100", "region": "usa", "sector": "tech",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "Najstarszy europejski fundusz na Nasdaq 100."},
    {"sym": "QDVE.DE", "isin": "IE00B3WJKG14", "name": "iShares S&P 500 Technology (Xetra)", "region": "usa", "sector": "tech",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Sektor technologiczny z S&P 500, rozliczany w euro."},
    {"sym": "IUMO.L", "isin": "IE00BD1F4N50", "name": "iShares MSCI USA Momentum Factor", "region": "usa", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Amerykańskie spółki w najsilniejszym trendzie wzrostowym."},
    {"sym": "XMUS.DE", "isin": "LU0274210672", "name": "Xtrackers MSCI USA", "region": "usa", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Szeroki rynek amerykański, ponad 600 spółek."},
    {"sym": "MOAT.L", "isin": "IE00BQQP9H09", "name": "VanEck Morningstar Wide Moat", "region": "usa", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Spółki z trwałą przewagą konkurencyjną — takie, których nie da się łatwo podgryźć."},

    # ---------------- branże świata
    {"sym": "XDWT.DE", "isin": "IE00BM67HT60", "name": "Xtrackers MSCI World Technology", "region": "world", "sector": "tech",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Technologia z całego świata, nie tylko amerykańska."},
    {"sym": "XDWH.DE", "isin": "IE00BM67HK77", "name": "Xtrackers MSCI World Health Care", "region": "world", "sector": "health",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Globalna ochrona zdrowia — najbardziej defensywna branża świata."},
    {"sym": "XDWF.DE", "isin": "IE00BM67HL84", "name": "Xtrackers MSCI World Financials", "region": "world", "sector": "finance",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Banki i ubezpieczyciele z rynków rozwiniętych."},
    {"sym": "XDWI.DE", "isin": "IE00BM67HV82", "name": "Xtrackers MSCI World Industrials", "region": "world", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Przemysł: maszyny, lotnictwo, transport, budownictwo."},

    # ---------------- tematyczne
    {"sym": "RBOT.L", "isin": "IE00BYZK4552", "name": "iShares Automation & Robotics", "region": "world", "sector": "ai",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Automatyzacja i robotyka — spółki zastępujące pracę ludzką maszynami."},
    {"sym": "BOTZ.L", "isin": "IE00BLCHJB90", "name": "Global X Robotics & Artificial Intelligence", "region": "world", "sector": "ai",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Czysta robotyka i automatyka przemysłowa: Keyence, Fanuc, ABB, Intuitive Surgical."},
    {"sym": "ROBO.L", "isin": "IE00BMW3QX54", "name": "L&G ROBO Global Robotics and Automation", "region": "world", "sector": "ai",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Szeroki koszyk automatyki: magazyny, czujniki, napędy i roboty przemysłowe."},
    {"sym": "GOAI.DE", "isin": "LU1861132840", "name": "Amundi MSCI Robotics & AI", "region": "world", "sector": "ai",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Robotyka razem ze sztuczną inteligencją — w czołówce duże spółki technologiczne."},
    {"sym": "ECAR.L", "isin": "IE00BGL86Z12", "name": "iShares Electric Vehicles", "region": "world", "sector": "clean",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Elektromobilność: producenci aut, baterii i surowców do nich."},
    {"sym": "DGTL.L", "isin": "IE00BYZK4883", "name": "iShares Digitalisation", "region": "world", "sector": "tech",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Cyfryzacja gospodarki — chmura, płatności, e-commerce."},
    {"sym": "AGED.L", "isin": "IE00BYZK4669", "name": "iShares Ageing Population", "region": "world", "sector": "health",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Spółki zarabiające na starzeniu się społeczeństw. Trend, którego nic nie odwróci."},
    {"sym": "ESPO.L", "isin": "IE00BYWQWR46", "name": "VanEck Video Gaming & eSports", "region": "world", "sector": "tech",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Gry i esport — producenci, wydawcy i twórcy sprzętu."},
    {"sym": "NUKL.DE", "isin": "IE000M7V94E1", "name": "VanEck Uranium & Nuclear", "region": "world", "sector": "energy",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Uran i energetyka jądrowa — wraca do łask razem z zapotrzebowaniem centrów danych."},
    {"sym": "GDX.L", "isin": "IE00BQQP9F84", "name": "VanEck Gold Miners", "region": "world", "sector": "gold",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Kopalnie złota. Chodzą jak złoto, tylko mocniej — w obie strony."},
    {"sym": "INFR.L", "isin": "IE00B1FZS467", "name": "iShares Global Infrastructure", "region": "world", "sector": "realestate",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "Drogi, lotniska, sieci przesyłowe — przewidywalne przepływy i wysokie dywidendy."},
    {"sym": "IH2O.L", "isin": "IE00B1TXK627", "name": "iShares Global Water", "region": "world", "sector": "clean",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "Infrastruktura wodna: uzdatnianie, przesył, liczniki."},
    {"sym": "LIFE.L", "isin": "IE00BLRPRR04", "name": "Rize Environmental Impact 100", "region": "world", "sector": "clean",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Sto spółek o najniższym wpływie środowiskowym w swoich branżach."},

    # ---------------- rynki wschodzące i Azja
    {"sym": "VFEM.L", "isin": "IE00B3VVMM84", "name": "Vanguard FTSE Emerging Markets", "region": "em", "sector": "broad",
     "asset": E, "cur": "GBP", "acc": False,
     "note": "Rynki wschodzące od Vanguarda, z wypłatą dywidendy."},
    {"sym": "VDEM.L", "isin": "IE00B3VVMM84", "name": "Vanguard FTSE EM (USD)", "region": "em", "sector": "broad",
     "asset": E, "cur": "USD", "acc": False,
     "note": "Ten sam fundusz rozliczany w dolarze."},
    {"sym": "IEMA.L", "isin": "IE00B4L5YC18", "name": "iShares MSCI EM", "region": "em", "sector": "broad",
     "asset": E, "cur": "USD", "acc": True,
     "note": "Duże i średnie spółki rynków wschodzących, bez małych."},
    {"sym": "XMME.DE", "isin": "IE00BTJRMP35", "name": "Xtrackers MSCI Emerging Markets", "region": "em", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Rynki wschodzące rozliczane w euro."},
    {"sym": "FLXC.DE", "isin": "IE00BHZRR147", "name": "Franklin FTSE China", "region": "em", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Chiny w najtańszej dostępnej formie."},
    {"sym": "FLXK.DE", "isin": "IE00BHZRR030", "name": "Franklin FTSE Korea", "region": "asia", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Korea Południowa — Samsung, Hyundai, SK Hynix."},

    # ---------------- Europa
    {"sym": "CSEMU.MI", "isin": "IE00B53QG562", "name": "iShares Core MSCI EMU", "region": "europe", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
     "note": "Strefa euro bez Wielkiej Brytanii i Szwajcarii — czysta ekspozycja na euro."},
    {"sym": "IEFM.L", "isin": "IE00BQN1K786", "name": "iShares MSCI Europe Momentum", "region": "europe", "sector": "broad",
     "asset": E, "cur": "GBP", "acc": True,
     "note": "Europejskie spółki w najsilniejszym trendzie."},
    {"sym": "SMEA.MI", "isin": "IE000MAO75G5", "name": "iShares Core MSCI Europe", "region": "europe", "sector": "broad",
     "asset": E, "cur": "EUR", "acc": True,
    ...
    {"sym": "IEGA.L", "isin": "IE00B4WXJJ64", "name": "iShares Core € Govt Bond", "region": "europe", "sector": "bond",
     "asset": B, "cur": "EUR", "acc": False,
     "note": "Obligacje skarbowe państw strefy euro."},
    {"sym": "IHYG.L", "isin": "IE00B4PY7Y77", "name": "iShares € High Yield Corp Bond", "region": "europe", "sector": "bond",
     "asset": B, "cur": "EUR", "acc": False,
     "note": "Dług firm o niższym ratingu — wyższe odsetki, realne ryzyko niewypłacalności."},
    {"sym": "ERNS.L", "isin": "IE00BCRY6227", "name": "iShares £ Ultrashort Bond", "region": "europe", "sector": "bond",
     "asset": B, "cur": "GBP", "acc": False,
     "note": "Bardzo krótki dług w funtach — parking na gotówkę."},

    # ---------------- surowce
    {"sym": "SGLD.L", "isin": "IE00B579F325", "name": "Invesco Physical Gold", "region": "world", "sector": "gold",
     "asset": C, "cur": "USD", "acc": True,
     "note": "Fizyczne złoto, jeden z najtańszych funduszy złota w Europie."},
    {"sym": "IGLN.L", "isin": "IE00B4ND3602", "name": "iShares Physical Gold (USD)", "region": "world", "sector": "gold",
     "asset": C, "cur": "USD", "acc": True,
     "note": "Złoto w sztabach, notowanie w dolarze."},
    {"sym": "PHAU.L", "isin": "JE00B1VS3770", "name": "WisdomTree Physical Gold", "region": "world", "sector": "gold",
     "asset": C, "cur": "USD", "acc": True,
     "note": "Kolejny fundusz na fizyczne złoto — warto porównać opłatę roczną."},
    {"sym": "SLVP.L", "isin": "IE00B43VDT70", "name": "Invesco Physical Silver", "region": "world", "sector": "gold",
     "asset": C, "cur": "GBP", "acc": True,
     "note": "Srebro fizyczne. Bardziej przemysłowe i dużo bardziej zmienne niż złoto."},
    {"sym": "CRUD.L", "isin": "GB00B15KXV33", "name": "WisdomTree WTI Crude Oil", "region": "world", "sector": "commodity",
     "asset": C, "cur": "USD", "acc": True,
